...
export default () => {
  return <section className="article">
    ...
    <div className="article__content">
      ...
      <p>Like what you see? Please speak to anyone in WRFC branded gear for more information on <Link to="/recruitment" onClick={() => { document.body.scrollTop = document.documentElement.scrollTop = 0;}}>how to join!</Link></p>
    </div>
